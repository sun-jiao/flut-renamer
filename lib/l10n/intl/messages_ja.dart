...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "挿入：${Intl.select(toEnd, {'true': '末尾から', 'false': '', 'other': ''})}第${insertIndex}文字に「${insert}」を挿入します。";
  ...
  static String m5(toEnd) =>
      "開始から終わりまでの数え方を切り替え、現在は${Intl.select(toEnd, {'true': '終わり', 'false': '始まり', 'other': ''})}から数えています";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': '選択中の', 'false': '選択されていない', 'other': ''})}${Intl.select(entityType, {'File': 'ファイル', 'Directory': 'ディレクトリ', 'Link': 'リンク', 'other': 'ファイルシステムオブジェクト'})}、ファイル名は${filename}、";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "切り詰め：${Intl.select(keepType, {'true': '保持する', 'false': '削除する', 'other': ''})}${Intl.select(iOneToEnd, {'true': '末尾から', 'false': '', 'other': ''})}第${iOne}文字から${Intl.select(iTwoToEnd, {'true': '末尾から', 'false': '', 'other': ''})}第${iTwo}文字までの内容。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "fileAlreadyExists": MessageLookupByLibrary.simpleMessage("ファイル名がすでに存在します"),
    ...
    "fileManagerSortButton": MessageLookupByLibrary.simpleMessage("ファイルの並べ替え"),
    ...
    "iosRemindTitle": MessageLookupByLibrary.simpleMessage("iOSでのファイル選択について"),
    ...
    "photoAltitude": MessageLookupByLibrary.simpleMessage("写真のGPS高度（Exifから）"),
    ...
    "photoLongitude": MessageLookupByLibrary.simpleMessage("写真のGPS経度（Exifから）"),
    "photoPhotographer": MessageLookupByLibrary.simpleMessage("写真家の名前（Exifから）"),
    "photoShutter": MessageLookupByLibrary.simpleMessage("シャッタースピード（Exifから）"),
    ...
    "transliterateLower": MessageLookupByLibrary.simpleMessage("小文字のラテン文字に変換"),
    "transliteratePinyin": MessageLookupByLibrary.simpleMessage("中国語をピンインに変換"),
    "transliterateSimplified": MessageLookupByLibrary.simpleMessage("簡体字に変換"),
    "transliterateToString": m10,
    "transliterateToStringCyrillic": m11,
    "transliterateTraditional": MessageLookupByLibrary.simpleMessage("繁体字に変換"),
    "transliterateUpper": MessageLookupByLibrary.simpleMessage("大文字のラテン文字に変換"),
