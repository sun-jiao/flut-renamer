...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "Inserisce \"${insert}\" all\'indice ${insertIndex}${Intl.select(toEnd, {'true': 'dalla fine', 'false': '', 'other': ''})}.";
  ...
  static String m5(toEnd) =>
      "Cambiamento della direzione del conteggio tra dall\'inizio e dalla fine, attualmente il conteggio da ${Intl.select(toEnd, {'true': 'la fine', 'false': 'l\'inizio', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'Selezionato', 'false': 'Non selezionato', 'other': ''})}${Intl.select(entityType, {'File': 'file', 'Directory': 'directory', 'Link': 'link', 'other': 'entity'})} chiamato ${filename},";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "Tronca: ${Intl.select(keepType, {'true': 'Mantieni solo', 'false': 'Rimuovi', 'other': ''})} contenuto tra la posizione ${iOne} e ${iTwo}${Intl.select(iTwoToEnd, {'true': 'dalla fine', 'false': '', 'other': ''})}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addedFilesCannotRename": MessageLookupByLibrary.simpleMessage(
      "Alcuni file non possono essere rinominati e sono stati ignorati.",
    ),
    ...
    "appInfo": MessageLookupByLibrary.simpleMessage("Informazioni sull\'app"),
    ...
    "descriptionInsertNumber": MessageLookupByLibrary.simpleMessage(
      "Inserisci il numero con il testo che lo precede e lo segue, mantenendo il nome originale.",
    ),
    ...
    "dragNotSupported": MessageLookupByLibrary.simpleMessage(
      "A causa delle restrizioni di sicurezza del sistema, il trascinamento di file da questa app non è supportato.",
    ),
    ...
    "expandOptions": MessageLookupByLibrary.simpleMessage("Espandi opzioni"),
    ...
    "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("Indietro"),
    ...
    "fileModifyTime": MessageLookupByLibrary.simpleMessage("Ora modifica file"),
    "fileNotExist": MessageLookupByLibrary.simpleMessage("File non esistente"),
    ...
    "hapticFeedback": MessageLookupByLibrary.simpleMessage("Feedback aptico"),
    ...
    "iosRemindTitle": MessageLookupByLibrary.simpleMessage(
      "Selezione dei file su iOS",
    ),
    "isRegex": MessageLookupByLibrary.simpleMessage("Usa espressione regolare"),
    ...
    "loadRules": MessageLookupByLibrary.simpleMessage("Carica regole"),
    "logEmpty": MessageLookupByLibrary.simpleMessage("Il registro è vuoto."),
    ...
    "metadataTags": MessageLookupByLibrary.simpleMessage("Tag dei metadati"),
    ...
    "musicAlbumName": MessageLookupByLibrary.simpleMessage("Nome dell\'album"),
    "musicAuthor": MessageLookupByLibrary.simpleMessage("Autore della traccia"),
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Numero del disco"),
    "musicGenres": MessageLookupByLibrary.simpleMessage("Generi della traccia"),
    ...
    "musicWriter": MessageLookupByLibrary.simpleMessage(
      "Scrittore della traccia",
    ),
    "musicYear": MessageLookupByLibrary.simpleMessage("Anno di pubblicazione"),
    ...
    "numberPositionHint": MessageLookupByLibrary.simpleMessage(
      "La posizione 0 indica l’inizio, oppure la fine quando si conta dalla fine.",
    ),
    "numberPrefix": MessageLookupByLibrary.simpleMessage(
      "Testo prima del numero",
    ),
    "numberSuffix": MessageLookupByLibrary.simpleMessage(
      "Testo dopo il numero",
    ),
    ...
    "photoDate": MessageLookupByLibrary.simpleMessage(
      "Data scatto foto (da EXIF)",
    ),
    "photoFocalLength": MessageLookupByLibrary.simpleMessage(
      "Lunghezza focale (da EXIF)",
    ),
    "photoISO": MessageLookupByLibrary.simpleMessage("Valore ISO (da EXIF)"),
    ...
    "ratingGithub": MessageLookupByLibrary.simpleMessage(
      "Metti un like su GitHub",
    ),
    "ratingStore": MessageLookupByLibrary.simpleMessage("Valuta su Store"),
    "ratingTitle": MessageLookupByLibrary.simpleMessage("Valuta la nostra app"),
    "rearrange": MessageLookupByLibrary.simpleMessage("Riordina"),
    "rearrangeDelimiter": MessageLookupByLibrary.simpleMessage("Delimitatore"),
    ...
    "removeRule": MessageLookupByLibrary.simpleMessage("Rimuovi questa regola"),
    ...
    "saveRules": MessageLookupByLibrary.simpleMessage("Salva regole"),
    ...
    "startIndex": MessageLookupByLibrary.simpleMessage("Indice di partenza"),
    ...
    "viewLog": MessageLookupByLibrary.simpleMessage("Visualizza registro"),
  };
}
