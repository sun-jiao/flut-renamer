...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "Insertar \"${insert}\" en la posición ${Intl.select(toEnd, {'true': 'final', 'false': 'inicial', 'other': ''})} en el índice ${insertIndex}.";
  ...
  static String m5(toEnd) =>
      "Cambiar la dirección de conteo entre desde el principio y desde el final, actualmente contando desde ${Intl.select(toEnd, {'true': 'el final', 'false': 'el principio', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'Seleccionado', 'false': 'No seleccionado', 'other': ''})}${Intl.select(entityType, {'File': 'archivo', 'Directory': 'directorio', 'Link': 'enlace', 'other': 'objeto del sistema de archivos'})} con nombre ${filename},";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "Truncar: ${Intl.select(keepType, {'true': 'Mantener', 'false': 'Eliminar', 'other': ''})} entre los caracteres ${iOne} y ${iTwo}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addFiles": MessageLookupByLibrary.simpleMessage(
      "Por favor, agrega archivos.",
    ),
    "addFilesAndroid": MessageLookupByLibrary.simpleMessage(
      "Seleccione uno o varios archivos para renombrar. Android puede pedirle que confirme los cambios en archivos multimedia.",
    ),
    "addRule": MessageLookupByLibrary.simpleMessage("Agregar regla"),
    "addedFilesCannotRename": MessageLookupByLibrary.simpleMessage(
      "Algunos archivos no se pueden renombrar y fueron ignorados.",
    ),
    ...
    "appError": MessageLookupByLibrary.simpleMessage("Error de la aplicación"),
    ...
    "descriptionInsertNumber": MessageLookupByLibrary.simpleMessage(
      "Inserta el número con el texto que lo rodea y conserva el nombre original.",
    ),
    ...
    "dragNotSupported": MessageLookupByLibrary.simpleMessage(
      "Debido a restricciones de seguridad del sistema, no se admite arrastrar y soltar archivos desde esta aplicación.",
    ),
    ...
    "errorDetails": MessageLookupByLibrary.simpleMessage("Detalles del error"),
    ...
    "expandOptions": MessageLookupByLibrary.simpleMessage("Expandir opciones"),
    ...
    "filesDirs": MessageLookupByLibrary.simpleMessage("Archivos y directorios"),
    ...
    "hapticFeedback": MessageLookupByLibrary.simpleMessage("Respuesta háptica"),
    ...
    "insertBeforeIndex": MessageLookupByLibrary.simpleMessage(
      "Insertar antes del índice",
    ),
    "insertIndex": MessageLookupByLibrary.simpleMessage("Índice de inserción"),
    "insertIntoOriginalName": MessageLookupByLibrary.simpleMessage(
      "Insertar en el nombre original",
    ),
    ...
    "isRegex": MessageLookupByLibrary.simpleMessage("Usar expresión regular"),
    ...
    "loadRules": MessageLookupByLibrary.simpleMessage("Cargar reglas"),
    "logEmpty": MessageLookupByLibrary.simpleMessage("El registro está vacío."),
    ...
    "musicAlbumName": MessageLookupByLibrary.simpleMessage("Nombre del álbum"),
    "musicAuthor": MessageLookupByLibrary.simpleMessage("Autor de la canción"),
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Número del disco"),
    ...
    "numberPositionHint": MessageLookupByLibrary.simpleMessage(
      "La posición 0 corresponde al inicio o al final si se cuenta desde el final.",
    ),
    ...
    "numberingMode": MessageLookupByLibrary.simpleMessage("Modo de numeración"),
    ...
    "photoAperture": MessageLookupByLibrary.simpleMessage("Apertura (EXIF)"),
    "photoCamName": MessageLookupByLibrary.simpleMessage(
      "Nombre de la cámara (EXIF)",
    ),
    ...
    "rating": MessageLookupByLibrary.simpleMessage("Calificar la aplicación"),
    ...
    "rearrangeDelimiter": MessageLookupByLibrary.simpleMessage("Delimitador"),
    ...
    "removeRule": MessageLookupByLibrary.simpleMessage("Eliminar esta regla"),
    ...
    "saveRules": MessageLookupByLibrary.simpleMessage("Guardar reglas"),
