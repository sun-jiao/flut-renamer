...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(toEnd) =>
      "Wechseln der Zählrichtung zwischen vom Anfang und vom Ende, aktuell wird gezählt ab ${Intl.select(toEnd, {'true': 'dem Ende', 'false': 'dem Anfang', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'Ausgewählt', 'false': 'Nicht ausgewählt', 'other': ''})}${Intl.select(entityType, {'File': 'Datei', 'Directory': 'Verzeichnis', 'Link': 'Verknüpfung', 'other': 'Dateisystemobjekt'})} mit dem Namen ${filename},";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addedFilesCannotRename": MessageLookupByLibrary.simpleMessage(
      "Einige Dateien können nicht umbenannt werden und wurden ignoriert.",
    ),
    ...
    "expandOptions": MessageLookupByLibrary.simpleMessage("Optionen erweitern"),
    ...
    "fromStart": MessageLookupByLibrary.simpleMessage("Von Anfang an zählen"),
    ...
    "insertToString": m1,
    "insertedText": MessageLookupByLibrary.simpleMessage("Einzufügender Text"),
    ...
    "musicAlbumArtist": MessageLookupByLibrary.simpleMessage("Albumkünstler"),
    "musicAlbumLength": MessageLookupByLibrary.simpleMessage(
      "Anzahl der Titel im Album",
    ),
    ...
    "musicTrackName": MessageLookupByLibrary.simpleMessage("Name des Titels"),
    "musicTrackNumber": MessageLookupByLibrary.simpleMessage(
      "Position des Titels im Album",
    ),
    "musicWriter": MessageLookupByLibrary.simpleMessage("Verfasser des Titels"),
    ...
    "photoAperture": MessageLookupByLibrary.simpleMessage(
      "Blendenöffnungswert (EXIF)",
    ),
    "photoCamName": MessageLookupByLibrary.simpleMessage("Kameraname (EXIF)"),
    ...
    "rearrangeDelimiter": MessageLookupByLibrary.simpleMessage("Trennzeichen"),
    ...
    "showThumbnails": MessageLookupByLibrary.simpleMessage("Bildminiaturen"),
    ...
    "transliterate": MessageLookupByLibrary.simpleMessage("Transliteration"),
