...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "Ekle: \"${insert}\" metnini ${Intl.select(toEnd, {'true': 'son', 'false': ''})} ${insertIndex}. konuma ekleyin.";
  ...
  static String m5(toEnd) =>
      "Başlangıçtan ve sondan sayma yönünü değiştirme, şu anda ${Intl.select(toEnd, {'true': 'son', 'false': 'başlangıç', 'other': ''})} sayımından";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'seçili olan', 'false': 'seçili olmayan', 'other': ''})}${Intl.select(entityType, {'File': 'dosya', 'Directory': 'dizin', 'Link': 'bağlantı', 'other': 'dosya sistem öğesi'})}, adı ${filename}.";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "Kırp: ${Intl.select(keepType, {'true': 'yalnızca tut', 'false': 'kaldır', 'other': ''})} ${Intl.select(iOneToEnd, {'true': 'sondan başlayarak', 'false': ''})} ${iOne}. konumdan ${Intl.select(iTwoToEnd, {'true': 'sondan başlayarak', 'false': ''})} ${iTwo}. konuma kadar içeriği.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "fileModifyTime": MessageLookupByLibrary.simpleMessage(
      "Dosya Değiştirme Saati",
    ),
    "fileNotExist": MessageLookupByLibrary.simpleMessage("Dosya mevcut değil"),
    ...
    "filesDirs": MessageLookupByLibrary.simpleMessage("Dosyalar ve Klasörler"),
    ...
    "musicAlbumArtist": MessageLookupByLibrary.simpleMessage("Albüm Sanatçısı"),
    ...
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Disk Numarası"),
    ...
    "musicTrackDuration": MessageLookupByLibrary.simpleMessage("Şarkı Süresi"),
    ...
    "photoISO": MessageLookupByLibrary.simpleMessage("ISO Değeri (EXIF\'ten)"),
    ...
    "transliterate": MessageLookupByLibrary.simpleMessage("Harf Değiştirme"),
