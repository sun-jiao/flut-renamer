...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "插入：在${Intl.select(toEnd, {'true': '倒数的', 'false': '', 'other': ''})}第${insertIndex}个字符处插入“${insert}”。";
  ...
  static String m5(toEnd) =>
      "切换计数方式是zhèng shǔ还是dào shǔ，当前是${Intl.select(toEnd, {'true': 'dào shǔ', 'false': 'zhèng shǔ', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': '已选中的', 'false': '未选中的', 'other': ''})}${Intl.select(entityType, {'File': '文件', 'Directory': '文件夹', 'Link': '链接', 'other': '文件系统对象'})}，文件名叫${filename}，";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "截取：${Intl.select(keepType, {'true': '仅保留', 'false': '移除', 'other': ''})}从${Intl.select(iOneToEnd, {'true': '倒数的', 'false': '', 'other': ''})}第${iOne}个字符至${Intl.select(iTwoToEnd, {'true': '倒数的', 'false': '', 'other': ''})}第${iTwo}个字符之间的内容。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "fileAlreadyExists": MessageLookupByLibrary.simpleMessage("文件名已被占用"),
    ...
    "fileManagerSaveButton": MessageLookupByLibrary.simpleMessage("添加已选文件至列表"),
    "fileManagerSortButton": MessageLookupByLibrary.simpleMessage("文件排序"),
    "fileManagerStorageButton": MessageLookupByLibrary.simpleMessage("选取存储器"),
    ...
    "photoAltitude": MessageLookupByLibrary.simpleMessage("照片GPS海拔（来自exif）"),
    ...
    "photoLongitude": MessageLookupByLibrary.simpleMessage("照片GPS经度（来自exif）"),
    "photoPhotographer": MessageLookupByLibrary.simpleMessage("摄影师姓名（来自exif）"),
    ...
    "transliterateSimplified": MessageLookupByLibrary.simpleMessage("转换为简体中文"),
    "transliterateToString": m10,
    "transliterateToStringCyrillic": m11,
    "transliterateTraditional": MessageLookupByLibrary.simpleMessage("转换为繁体中文"),
