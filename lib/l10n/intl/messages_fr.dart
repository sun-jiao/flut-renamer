...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "Insertion : Insérer \"${insert}\" à la position ${insertIndex}, ${Intl.select(toEnd, {'true': 'en partant de la fin', 'false': '', 'other': 'à partir du début'})}.";
  ...
  static String m5(toEnd) =>
      "Changement de direction de comptage entre du début et de la fin, comptant actuellement à partir de ${Intl.select(toEnd, {'true': 'la fin', 'false': 'le début', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'Sélectionné', 'false': 'Non sélectionné', 'other': ''})}${Intl.select(entityType, {'File': 'fichier', 'Directory': 'répertoire', 'Link': 'lien', 'other': 'objet du système de fichiers'})} nommé ${filename},";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "Troncature : ${Intl.select(keepType, {'true': 'Conserver uniquement', 'false': 'Supprimer', 'other': ''})} entre ${Intl.select(iOneToEnd, {'true': 'la dernière', 'false': '', 'other': 'la première'})} position ${iOne} et ${Intl.select(iTwoToEnd, {'true': 'la dernière', 'false': '', 'other': 'la deuxième'})} position ${iTwo}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addFilesAndroid": MessageLookupByLibrary.simpleMessage(
      "Sélectionnez un ou plusieurs fichiers à renommer. Android peut vous demander de confirmer la modification des fichiers multimédias.",
    ),
    ...
    "addedFilesCannotRename": MessageLookupByLibrary.simpleMessage(
      "Certains fichiers ne peuvent pas être renommés et ont été ignorés.",
    ),
    ...
    "descriptionInsertNumber": MessageLookupByLibrary.simpleMessage(
      "Insérer le numéro avec le texte qui l’entoure tout en conservant le nom d’origine.",
    ),
    ...
    "fileNotExist": MessageLookupByLibrary.simpleMessage("Fichier inexistant"),
    ...
    "filesDirs": MessageLookupByLibrary.simpleMessage("Fichiers & Répertoires"),
    ...
    "hapticFeedback": MessageLookupByLibrary.simpleMessage("Retour haptique"),
    ...
    "insertBeforeIndex": MessageLookupByLibrary.simpleMessage(
      "Insérer avant l\'index",
    ),
    "insertIndex": MessageLookupByLibrary.simpleMessage("Index d\'insertion"),
    "insertIntoOriginalName": MessageLookupByLibrary.simpleMessage(
      "Insérer dans le nom d’origine",
    ),
    ...
    "loadRules": MessageLookupByLibrary.simpleMessage("Charger les règles"),
    "logEmpty": MessageLookupByLibrary.simpleMessage("Le journal est vide."),
    ...
    "musicAlbumName": MessageLookupByLibrary.simpleMessage("Nom de l\'album"),
    "musicAuthor": MessageLookupByLibrary.simpleMessage("Auteur de la piste"),
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Numéro du disque"),
    ...
    "musicTrackName": MessageLookupByLibrary.simpleMessage("Nom de la piste"),
    ...
    "photoAperture": MessageLookupByLibrary.simpleMessage("Ouverture (EXIF)"),
    ...
    "photoISO": MessageLookupByLibrary.simpleMessage("Sensibilité ISO (EXIF)"),
    ...
    "rearrangeDelimiter": MessageLookupByLibrary.simpleMessage("Délimiteur"),
    ...
    "removeRule": MessageLookupByLibrary.simpleMessage("Supprimer cette règle"),
    ...
    "saveRules": MessageLookupByLibrary.simpleMessage("Enregistrer les règles"),
    ...
    "viewLog": MessageLookupByLibrary.simpleMessage("Voir le journal"),
  };
}
