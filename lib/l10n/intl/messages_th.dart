...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "แทรก: แทรก \"${insert}\" ที่ตำแหน่งที่ ${Intl.select(toEnd, {'true': 'สุดท้าย', 'false': '', 'other': ''})} ${insertIndex}";
  ...
  static String m5(toEnd) =>
      "สลับทิศทางการนับระหว่างจากจุดเริ่มต้นและจากจุดสิ้นสุด ณ ปัจจุบันกำลังนับจาก ${Intl.select(toEnd, {'true': 'จุดสิ้นสุด', 'false': 'จุดเริ่มต้น', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'ไฟล์ที่เลือก', 'false': 'ไฟล์ที่ไม่ได้เลือก', 'other': 'อ็อบเจ็กต์ในระบบไฟล์'})} ชื่อไฟล์คือ ${filename} และ";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "ตัด: ${Intl.select(keepType, {'true': 'เก็บเฉพาะ', 'false': 'ลบ', 'other': ''})} ตั้งแต่ตำแหน่งที่ ${Intl.select(iOneToEnd, {'true': 'สุดท้าย', 'false': '', 'other': ''})} ${iOne} ไปยังตำแหน่งที่ ${Intl.select(iTwoToEnd, {'true': 'สุดท้าย', 'false': '', 'other': ''})} ${iTwo}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addFilesAndroid": MessageLookupByLibrary.simpleMessage(
      "เนื่องจากข้อจำกัดของระบบ ไฟล์ที่เลือกจากแท็บส่วนใหญ่ในตัวเลือกจะไม่สามารถเปลี่ยนชื่อได้\nโดยทั่วไปไฟล์ที่เลือกจาก [Device Name] จะสามารถเปลี่ยนชื่อได้ แต่อาจแตกต่างกันไปขึ้นอยู่กับอุปกรณ์",
    ),
    ...
    "dragToAdd": MessageLookupByLibrary.simpleMessage(
      "ลากและวางไฟล์เพื่อเพิ่ม",
    ),
    "dropToAdd": MessageLookupByLibrary.simpleMessage(
      "วางไฟล์ที่นี่เพื่อเพิ่ม",
    ),
    ...
    "fileCreateDate": MessageLookupByLibrary.simpleMessage("วันที่สร้างไฟล์"),
    "fileCreateTime": MessageLookupByLibrary.simpleMessage("เวลาสร้างไฟล์"),
    "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("ย้อนกลับ"),
    ...
    "fileModifyDate": MessageLookupByLibrary.simpleMessage("วันที่แก้ไขไฟล์"),
    ...
    "iosRemindTitle": MessageLookupByLibrary.simpleMessage(
      "เกี่ยวกับการเลือกไฟล์บน iOS",
    ),
    "isRegex": MessageLookupByLibrary.simpleMessage(
      "ใช้เป็น Regular Expression",
    ),
    ...
    "photoPhotographer": MessageLookupByLibrary.simpleMessage(
      "ชื่อช่างภาพ (จาก exif)",
    ),
    "photoShutter": MessageLookupByLibrary.simpleMessage(
      "ความเร็วชัตเตอร์ (จาก exif)",
    ),
    "photoTime": MessageLookupByLibrary.simpleMessage("เวลาถ่ายภาพ (จาก exif)"),
