...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(toEnd, ordinal, insert, insertIndex) =>
      "Inserir: inserir \"${insert}\" na ${Intl.select(toEnd, {'true': 'última', 'false': '', 'other': ''})} posição ${insertIndex}.";
  ...
  static String m5(toEnd) =>
      "Alternar direção de contagem entre do início e do fim, atualmente contando a partir de ${Intl.select(toEnd, {'true': 'o final', 'false': 'o início', 'other': ''})}";
  ...
  static String m9(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'Selecionado', 'false': 'Não selecionado', 'other': ''})}${Intl.select(entityType, {'File': 'arquivo', 'Directory': 'diretório', 'Link': 'link', 'other': 'objeto do sistema de arquivos'})} chamado ${filename},";
  ...
  static String m12(
    ...
    iTwo,
      ...
      "Truncar: ${Intl.select(keepType, {'true': 'manter apenas', 'false': 'remover', 'other': ''})} do ${Intl.select(iOneToEnd, {'true': 'último', 'false': '', 'other': ''})} ${iOne}º ao ${Intl.select(iTwoToEnd, {'true': 'último', 'false': '', 'other': ''})} ${iTwo}º caractere.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addFilesAndroid": MessageLookupByLibrary.simpleMessage(
      "Devido a restrições do sistema, os arquivos selecionados na maioria das abas do seletor não podem ser renomeados.\nOs arquivos selecionados de [Device Name] geralmente podem ser renomeados, embora os resultados possam variar dependendo do dispositivo.",
    ),
    ...
    "errorDetails": MessageLookupByLibrary.simpleMessage("Detalhes do erro"),
    ...
    "expandOptions": MessageLookupByLibrary.simpleMessage("Expandir opções"),
    ...
    "fileNotExist": MessageLookupByLibrary.simpleMessage("Arquivo não existe"),
    ...
    "filesDirs": MessageLookupByLibrary.simpleMessage("Arquivos e diretórios"),
    ...
    "isRegex": MessageLookupByLibrary.simpleMessage("Usar expressão regular"),
    ...
    "metadataTags": MessageLookupByLibrary.simpleMessage("Tags de metadados"),
    ...
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Número do disco"),
    ...
    "musicWriter": MessageLookupByLibrary.simpleMessage("Escritor da faixa"),
    "musicYear": MessageLookupByLibrary.simpleMessage(
      "Ano de lançamento da faixa",
    ),
    ...
    "removeRule": MessageLookupByLibrary.simpleMessage("Remover esta regra"),
